...
Pod::Spec.new do |s|
  s.name             = 'LFSwiftLib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LFSwiftLib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/liulinfan/LFSwiftLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'liulinfan' => '361087115@qq.com' }
  s.source           = { :git => 'https://github.com/liulinfan/LFSwiftLib.git', :tag => s.version.to_s }
